...
var p7 = new Platform(0, height - 162, 0.4, false);
var item = new Item(0, height - 200, 'apples');
var starsList2 = [new Star(width / 2 - 10, height - 202), new Star(width / 2 + 340, height - 292)];
var exit3 = new Exit(width / 2 - 445, height - 469, -1);
var Level1_3 = new Level('Level 1-3', [p3, p4, p5, p6, p7], {walkers:[Teddy1]}, starsList2, [item], 10, height-70, exit3);

// LEVEL 1-4
var Tick1 = new Shooter(width / 2 - 25, height - 390, 'Tick', 2, 2000);
var p7 = new Platform(width / 2 + 150, height - 442, 0.4, false);
var item = new Item(width / 2 + 160, height - 480, 'first aid');
var Level1_4 = new Level('Level 1-4', [p3, p4, p5, p6, p7], {walkers:[Teddy1], shooters:[Tick1]}, starsList2, [item], 10, height-70, exit3);
...
var starsList3 = [new Star((width/2) - 200, height-50), new Star((width/2) + 200, height-50), new Star(width-68, height-198)];
var item = new Item(width-38, height-50, 'defense');
var Level1_5 = new Level('Level 1-5', [p7, p8], {walkers: [Teddy1], shooters:[Tick2]}, starsList3, [item], 10, height-70, exit4);
...
var p14 = new Platform(width-200, height-442, 1, false);
...
var exit5 = new Exit(width/2 - 30, height-550, 1);
var item = new Item(width/2 + 30, height-560, 'heart');
var item2 = new Item(width/2-10, height-270, 'first aid');
var starsList4 = [new Star(390, height-180), new Star(390, height-330), new Star(390, height-480), new Star(width-410, height-180), new Star(width-410, height-330), new Star(width - 200, height - 480)];
...
var Level1_6 = new Level('Level 1-6', [p9, p10, p11, p12, p13, p14, p15, p16, p17], {shooters:[Tick4], walkers:[Teddy1], statics:[Tick3], flyers:[Planey1, Planey2, Planey3]}, starsList4, [item, item2], 10, height-70, exit5);
...
var p27 = new Platform(850, 290, 1, true);
var p28 = new Platform(width-50, 325, 0.5, false);
var p29 = new Platform(width-20, 220, 0.2, false);
var p30 = new Platform(width-350, 120, 0.5, false);
var p31 = new Platform(0, 315, 0.3, false);
var p32 = new Platform(850, 470, 0.3, true);
var p33 = new Platform(1000, 400, 0.3, true);
var starsList6 = [new Star(width-25, 180), new Star(width-25, 250)];
var exit7 = new Exit(width-355, 100, 1);
var Tick5 = new Shooter(5, 260, 'Tick', 5, 2000);
var item = new Item(500, 250, 'speed');
var item2 = new Item(840, 430, 'balls');
var Level1_8 = new Level('Level 1-8', [p25, p26, p27, p28, p29, p30, p31, p32, p33], {shooters:[Tick5]}, starsList6, [item, item2], 20, 150, exit7);
...
var starsList7 = [new Star(width-30, height-50), new Star(width-30, height-150), new Star(width-400, height-250), new Star(260, height-430), new Star(width/2-10, height-510), new Star(width-200, height-440)];
...
var Tick6 = new Shooter(290, height-430, 'Tick', 3, 2000);
var Ratz = new Walker(width-100, height - 80, 'DirtyRatz', 10);
var item = new Item(width/2 - 20, height-345, 'apples');
var Level1_9 = new Level('Level 1-9', [p33, p35, p36, p37, p38, p39, p40, p41], {walkers:[Ratz], flyers:[Planey4], shooters:[Tick6]}, starsList7, [item], width/2, height-100, exit8);
...
var item = new Item(width/2 + 30, height-560, 'balls');
var item2 = new Item(width - 200, height-480, 'first aid');
var Level1_10 = new Level('Level 1-10', [p9, p10, p11, p12, p13, p14, p15, p16, p17], {shooters:[Tick7], walkers:[Ratz], flyers:[Planey5, Planey2, Planey3]}, starsList4, [item, item2], 10, height-70, exit5);

var p42 = new Platform(width/2 - 260, height - 110, 1, false);
var p43 = new Platform(width/2 + 260, height - 110, 1, false);

var item = new Item(width/2 + 250, height - 160, 'apples');
var item2 = new Item(width/2 - 270, height - 160, 'apples');
var item3 = new Item(30, height - 50, 'first aid');

var p44 = new Platform(25, height - 200, 0.2, false);
var p45 = new Platform(width - 25, height - 200, 0.2, false);

var bossToy = new Boss(200, height - 200, 50, 'ToyTrojan');

var Tick7 = new Shooter(0, height - 250, 'Tick', 10, 2000);
var Tick8 = new Shooter(width - 2, height - 250, 'Tick', 10, 2000);

var Level1_11 = new Level('Boss', [p42, p43, p44, p45], {shooters:[Tick7, Tick8], boss: bossToy}, [], [item, item2, item3], width - 100, height - 100, null);
